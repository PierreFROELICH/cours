...
public function getVentesSupMt($montant)
{
$lesVentesSel = array();
foreach($this->lesVentes as $uneVente) //parcours de la liste
{
if ($uneVente->getMontantVente() > $montant)
//on ajoute la vente à la collection
    { $lesVentesSel[]=$uneVente->getMontantVente() ; }
}
return $lesVentesSel ;
...
public function __construct ($uneDateVente, $unConso, $unMontant,$uneAdresseLivraison, $uneOptionLivraison){
    parent::__construct($uneDateVente, $unConso, $unMontant);
    $this->adresseLivraison = $uneAdresseLivraison ;
    $this->optionLivraison = $uneOptionLivraison ;
...
public function __construct ($uneDateVente, $unConso, $unMontant,$unVendeur){
    parent::__construct($uneDateVente, $unConso, $unMontant);
    $this->matriculeVendeur = $unVendeur ;
}
}
